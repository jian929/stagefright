...
protected:
    ...
    virtual OMX_ERRORTYPE ProcessorInit(void) = 0;  /* Loaded to Idle */
    virtual OMX_ERRORTYPE ProcessorDeinit(void) = 0;/* Idle to Loaded */
    virtual OMX_ERRORTYPE ProcessorStart(void); /* Idle to Executing/Pause */
    virtual OMX_ERRORTYPE ProcessorStop(void) = 0;  /* Executing/Pause to Idle */
